...
import { Download, Wrench, Circle } from "lucide-react"

interface DevlogEntry {
  project: string
  color: string        // dot + badge color (rgba base, without alpha)
...
// rgb base values per project (used to build rgba strings)
const PROJECT_COLORS: Record<string, string> = {
  "BewerbungsPilot": "74, 222, 128",   // green
  "Poke-Scan V2":    "207, 147, 54",   // copper
  "Portfolio":       "96, 165, 250",   // blue
  "CelDesk":         "167, 139, 250",  // purple
}

// Chronological order: BewerbungsPilot → Poke-Scan V2 → Portfolio → CelDesk
